...
[![Go Reference](https://pkg.go.dev/badge/github.com/wlrgo/result.svg)](https://pkg.go.dev/github.com/wlrgo/result)
...
```bash
go get github.com/wlrgo/result
```
...
func main() {
	...
	fmt.Println(result.Map(res, func(n int) int { return n * 10 }).UnwrapOr(-1))
}
```
...
See [pkg.go.dev/github.com/wlrgo/result](https://pkg.go.dev/github.com/wlrgo/result)
